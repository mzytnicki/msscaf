...
../CheckScaffolding/checkBreaks /Scratch/mazytnicki/Mother_1/mapping.paf /Scratch/mazytnicki/Mother_1/mother_raw.cgt.len 100000 10000 outBreaks.tsv
...
allObject@data <- map(allObject@data, .checkJoins, sizes = allObject@sizes, 0.05)
png("tmp.png")
allObject@data[[3]]@joins@mapPlots[[1]]
dev.off()
png("tmp2.png")
allObject@data[[3]]@joins@testPlots[[1]]
dev.off()
