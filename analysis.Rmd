...
hicObject@parameters@minCount     <- 5
hicObject@parameters@maxLinkRange <- 500
hicObject@parameters@minRowCount  <- 200
...
hicObject@parameters@breakNCells    <- 1000
hicObject@parameters@breakThreshold <- -1.5
...
bamObject@parameters@breakThreshold <- -6
bamObject@parameters@breakNCells    <- 50
...
ontData <- parsePafFile(ontFileName, 10000, 50, 10, 10)
