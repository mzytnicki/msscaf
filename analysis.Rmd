...
allObject@data[[1]]@parameters@minCount       <- 3
allObject@data[[1]]@parameters@maxLinkRange   <- 500
allObject@data[[1]]@parameters@minRowCount    <- 10
allObject@data[[1]]@parameters@loessSpan      <- 0.5
allObject@data[[1]]@parameters@maxLinkRange   <- 2
allObject@data[[1]]@parameters@breakNCells    <- 3
allObject@data[[1]]@parameters@breakThreshold <- -5
allObject@data[[2]]@parameters@minCount       <- 2
allObject@data[[2]]@parameters@minRowCount    <- 10
allObject@data[[2]]@parameters@breakNCells    <- 30
...
```{bash}
# From tapou
~/Desktop/Apps/quast-5.0.2/quast-lg.py /Scratch/mazytnicki/Mother_1/mother_raw.cgt.fa -r /Scratch/mazytnicki/GCF_002263795.1_ARS-UCD1.2_genomic.fna.gz -t 6 -o /home/mazytnicki/Desktop/Projects/Other/Assembly/Quast/
